...
public class Employer {
    ...
    public Week getWeek(int i) throws WeekOutOfBoundsException {
        if (i < 1 || i > 52) {
            throw new WeekOutOfBoundsException("Week out of bounds");
        }
    ...
    private JSONArray weeksToJson() {
        ...
        for (Week w: weeksInWorkingYear) {
            //jsonArray.put(weekCounter);
